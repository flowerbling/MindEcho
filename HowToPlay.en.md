...
*   **Scenes:** The game is divided into different scenes or maps. You can switch between unlocked scenes using the "Switch Scene" (切换场景) button.
...
*   **Game Rules:** The AI will generate a set of rules that govern the game world. You can view the current rules by clicking the "View Rules" (查看法则) button. These rules may change as the story progresses.
